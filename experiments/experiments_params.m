...
techniques = {'mcg','saliencyflt-color','saliencyflt-motion',...
              'nonlocalconsensus','cvos','tracingdisco','moseg',...
              'keysegments','saliencyseg','fastvideoseg',...
              'tsp','seamseg','hvs','jumpcut','fcp','bvs'};
